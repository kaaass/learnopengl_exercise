...
const char* vertShaderPath = "shader/transformation.vs";
const char* fragShaderPath = "shader/transformation.fs";
...
void drawStaff() {
    ...
    trans = glm::mat4(1.0);
    trans = glm::translate(trans, glm::vec3(-0.5f, 0.5f, 0.0f));
    trans = glm::scale(trans, abs(sin((float) glfwGetTime()))* glm::vec3(1., 1., 1.));
    // Pass the transform matrix
    glUniformMatrix4fv(transformLoc, 1, GL_FALSE, glm::value_ptr(trans));
